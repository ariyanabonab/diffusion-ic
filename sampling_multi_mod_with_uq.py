...
# NEW: intrinsic variance decomposition (see intrinsic_variance.py, same folder)
from intrinsic_variance import compare_true_vs_predicted
...
print("\nLoading data...")
fd_all = np.load('/work/hdd/bdne/abonab/fd_cdmgas_1P_64_norm.npy')
...
# down to per-bin scalars (see intrinsic_variance.py's note on Figure 4).
...
axes[1].set_xticklabels(['Truth', 'Inferred'])
